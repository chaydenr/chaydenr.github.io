...
export const Contact = () => {
  return (
    <div className="container px-0 overflow-hidden">
      ...
      {/* <p className="text-center md:text-lg lg:text-xl text-white/60 pt-5 md:pt-8">
        Based in Honolulu, HI and open to work all over O'ahu. Message me on
        LinkedIn, or shoot me an e-mail, and check out my GitHub while you're
        here!
      </p> */}
      {/* <div className="bg-gray-800 rounded-3xl p-6 relative overflow-hidden z-0">
        <div className="absolute inset-0 opacity-5 -z-10" style={{
          backgroundImage:`url(${GrainImage})`
        }}>
          <img src={OahuImage}></img>
        </div>
      </div> */}
  ...
  <div className="bg-gradient-to-r from-emerald-300 to-sky-400 text-gray-900 rounded-3xl p-6 md:p-8 flex flex-col justify-center">
    ...
    <div className="mt-6 flex flex-wrap justify-center gap-3">
      <button className="text-white bg-gray-900 inline-flex items-center h-12 px-4 rounded-xl gap-2">
